...
export default {
    name: 'Institution',
    components: {
        AuthenticatedLayout, Head, Link, Input, Label
    },
    props: {
        institution: Object,
    },
