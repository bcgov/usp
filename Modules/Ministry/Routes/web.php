...
Route::prefix('ministry')->group(function () {
    Route::group(
        ...
        Route::get('/institutions/show/{institution}/{page?}', [InstitutionController::class, 'show'])->name('institutions.show');
        Route::put('/institutions/update', [InstitutionController::class, 'update'])->name('institutions.update');
