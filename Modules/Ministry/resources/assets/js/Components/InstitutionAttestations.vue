    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            <template v-if="capStat != '' && capStat.instCap != null">
                ...
                <span class="badge rounded-pill text-bg-primary me-1">Total Issued PAL: {{ capStat.issued + capStat.issuedGrad + capStat.declined + capStat.declinedGrad }}</span>
                <span class="badge rounded-pill text-bg-primary me-1">Total Remaining PAL: {{ capStat.totalRemaining }}</span>
                <span class="badge rounded-pill text-bg-primary me-1">Issued Grad. PAL: {{ capStat.gradIssued }}</span>
                <span class="badge rounded-pill text-bg-primary me-1">Issued Undergrad. PAL: {{ capStat.issued - capStat.gradIssued }}</span>
